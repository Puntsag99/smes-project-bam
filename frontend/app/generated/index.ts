...
export type ReturnQuery = { __typename?: 'Query', Return: Array<{ __typename?: 'ProductReturn', id: string, productId: string, deliveryPersonId?: string | null, shopId: string, pieces: number, signature: string, created_at: string, shop?: { __typename?: 'Shop', id: string, name: string, address: string, is_active: boolean, email: string, phone_number: string } | null, deliveryPerson?: { __typename?: 'DeliveryPerson', id?: string | null, name?: string | null, phoneNumber?: string | null, image?: string | null, createdAt?: string | null, updatedAt?: string | null } | null, product?: { __typename?: 'Product', id: string, title: string, description?: string | null, type: string, stock: number, ingredient?: string | null, barcode?: string | null, price?: number | null, imageURL?: string | null, expiredAt?: string | null, createdAt?: string | null, updatedAt?: string | null } | null }> };
